...
const Profiledoctor = () => {
  ...
  return (
    <>
      ...
      <div className="bg-white grid gap-10  py-10 ">
        {Filter(Doctor).map((val, i) => {
          return (
            <div className=" flex shadow-xl h-40  cursor-pointer rounded-lg bg-gray-200  hover:scale-105 transition-all delay-75 duration-200 ease-in w-7/12 mx-auto">
              <figure className="">
                <img
                  src={val.image}
                  alt="Movie"
              ...
              <div className="card-body px-10">
                <h2 className="card-title text-black text-md">{val.name}</h2>
