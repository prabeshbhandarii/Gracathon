            ...
            <div className="sm:col-span-2">
              ...
              <div className="relative mt-2.5">
                <input
                  ...
                  id="phone-number"
                  autocomplete="tel"
                  className="block w-full bg-white rounded-md border-0 px-16 py-2 pl-20 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                />
              </div>
            </div>
            <div className="sm:col-span-2">
